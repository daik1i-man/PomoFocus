...
export default function AddTaskModal() {
    const { openAddTaskModal, setOpenAddTaskModal } = useContext(ActionsContextProvider);
    ...
    const AddTaskHandler = (e) => {
        ...
        setFakeDatas([...fakeDatas, newTask]);
    ...
    return (
        <Transition show={openAddTaskModal}>
            <Dialog className="relative z-10" onClose={setOpenAddTaskModal}>
                <TransitionChild
