...
export default function DeleteTaskModal({ id }) {
    const { openDeleteTaskModal, setOpenDeleteTaskModal } = useContext(ActionsContextProvider)
    const { } = useContext(DatasContextProvider);

    return (
        <Transition show={openDeleteTaskModal}>
            <Dialog className="relative z-10" onClose={setOpenDeleteTaskModal}>
                <TransitionChild
